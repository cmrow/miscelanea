...
public class Ejercicio1 {
    ...
    private static void llamarEjercicio(int numeral) {
        ...
        switch (numeral) {
            ...
            case 2:
                ...
                solicitarNumero();
            case 3:
                System.out.println("CUADRADO DE UN NÚMERO");
                System.out.println("Indique el número");
                num1 = entrada.nextInt();
                cuadrado(num1);
                solicitarNumero();
            case 4:
                System.out.println("**La suma de 1234 y 532**".toUpperCase());
                System.out.println("El resultado es: " + (A + B));
                solicitarNumero();
            case 5:
                System.out.println("**La resta de 1234 y 532**".toUpperCase());
                System.out.println("Es igual a: " + (A - B));
                solicitarNumero();
            case 6:
                System.out.println("**La Multiplicación de 1234 y 532**".toUpperCase());
                System.out.println("Es igual a: " + (A * B));
                solicitarNumero();
            case 7:
                System.out.println("**La división de 1234 y 532**");
                System.out.println("Es igual a: " + (A / B));
                solicitarNumero();
            case 8:
                System.out.println("**El Módulo de 1234 y 532**");
                System.out.println("Es igual a: " + (A % B));
                solicitarNumero();
            case 9:
                System.out.println("**Cambio de euros a dolares ".toUpperCase());
                System.out.println("Indique la cantidad de euros");
                num1 = entrada.nextDouble();
                cambio(num1);
                solicitarNumero();
            case 10:
                System.out.println("**Área de un rectangulo".toUpperCase());
    ...
    private static void cuadrado(double num1) {
        System.out.println("El cuadrado de " + num1 + " = " + Math.pow(num1, 2));
    }

    private static void cambio(double num1) {
        System.out.println("El cambio a dolares " + num1 * 1.195);
